...
class dataProcess(object):
	...
	def __init__(self, out_rows, out_cols, data_path = "F:/python/code/unet/data/train/image", label_path = "F:/python/code/unet/data/train/label", test_path = "F:/python/code/unet/data/test", npy_path = "npydata", img_type = "tif"):
