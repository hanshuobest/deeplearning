...
parser = OptionParser()
parser.add_option("-p", "--path", dest="train_path", help="Path to training data." , default='/home/han/DataSets/VOCdevkit-2012') # 训练文件路径
...
parser.add_option("--network", dest="network", help="Base network to use. Supports vgg or resnet50.", default='vgg') # 使用的基本网络
...
# 默认权重文件
parser.add_option("--input_weight_path", dest="input_weight_path", help="Input path for weights. If not specified, will try to load default weights provided by keras." , default='vgg19_weights_tf_dim_ordering_tf_kernels.h5')
